 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureportplus.export.word.high;
...
import com.kingint.ureportplus.definition.Alignment;
import com.kingint.ureportplus.definition.Border;
import com.kingint.ureportplus.definition.BorderStyle;
...
import com.kingint.ureportplus.export.Producer;
import com.kingint.ureportplus.export.word.DxaUtils;
import com.kingint.ureportplus.model.Cell;
import com.kingint.ureportplus.model.Column;
import com.kingint.ureportplus.model.Image;
import com.kingint.ureportplus.model.Report;
import com.kingint.ureportplus.model.Row;
import com.kingint.ureportplus.utils.ImageUtils;
import com.kingint.ureportplus.utils.UnitUtils;
...
public class WordProducer implements Producer{
	public static final String BEAN_ID="ureportplus.wordExporter";
			...
			if(StringUtils.isNotBlank(base64Data)){
				...
				try{
					...
					if(imageType.equals("jpeg")){
						run.addPicture(inputStream, XWPFDocument.PICTURE_TYPE_JPEG, "ureportplus-"+rowNumber+"-"+columnNumber+".jpg", Units.toEMU(width), Units.toEMU(height));					
					}else if(imageType.equals("png")){
						run.addPicture(inputStream, XWPFDocument.PICTURE_TYPE_PNG, "ureportplus-"+rowNumber+"-"+columnNumber+".png", Units.toEMU(width), Units.toEMU(height));					
					}else if(imageType.equals("gif")){
						run.addPicture(inputStream, XWPFDocument.PICTURE_TYPE_GIF, "ureportplus-"+rowNumber+"-"+columnNumber+".gif", Units.toEMU(width), Units.toEMU(height));					
					}
				}catch(Exception ex){
					throw new ReportComputeException(ex);
				}finally{

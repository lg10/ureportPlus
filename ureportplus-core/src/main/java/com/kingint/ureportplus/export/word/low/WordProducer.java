 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureportplus.export.word.low;
		...
		if(value instanceof String){
			...
			try{
				...
				if(imageType.equals("jpeg")){
					run.addPicture(inputStream, HWPFDocument.PICTURE_TYPE_JPEG, "ureportplus-"+rowNumber+"-"+columnNumber+".jpg", Units.toEMU(width), Units.toEMU(height));					
				}else if(imageType.equals("png")){
					run.addPicture(inputStream, HWPFDocument.PICTURE_TYPE_PNG, "ureportplus-"+rowNumber+"-"+columnNumber+".png", Units.toEMU(width), Units.toEMU(height));					
				}else if(imageType.equals("gif")){
					run.addPicture(inputStream, HWPFDocument.PICTURE_TYPE_GIF, "ureportplus-"+rowNumber+"-"+columnNumber+".gif", Units.toEMU(width), Units.toEMU(height));					
				}
			}catch(Exception ex){
				throw new ReportComputeException(ex);
			}finally{

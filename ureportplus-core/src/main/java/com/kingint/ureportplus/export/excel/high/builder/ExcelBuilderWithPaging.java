 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureportplus.export.excel.high.builder;
...
import com.kingint.ureportplus.export.excel.high.CellStyleContext;
...
public class ExcelBuilderWithPaging extends ExcelBuilder{
	public void build(Report report, OutputStream outputStream,boolean withSheet) {
		...
		try{
			...
			Map<Row,Map<Column,com.kingint.ureportplus.model.Cell>> cellMap=report.getRowColCellMap();
			...
			for(Page page:pages){
				...
				for(int rowIndex=0;rowIndex<rows.size();rowIndex++){
		        	...
		        	Map<Column,com.kingint.ureportplus.model.Cell> colCell=cellMap.get(r);
		        	int skipCol=0;
		        	for(int i=0;i<columnSize;i++){
		        		...
		        		com.kingint.ureportplus.model.Cell cellInfo=null;
		        		if(colCell!=null){

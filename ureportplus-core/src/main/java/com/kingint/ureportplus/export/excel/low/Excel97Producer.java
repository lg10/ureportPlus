 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureportplus.export.excel.low;
...
import com.kingint.ureportplus.definition.PaperType;
				...
				for(Page page:pages){
					...
					for(Row r:rows){
			        	...
			        	for(int i=0;i<columnSize;i++){
			        		...
			        		com.kingint.ureportplus.model.Cell cellInfo=colCell.get(col);
			        		if(cellInfo==null){
			        			continue;
			        		}

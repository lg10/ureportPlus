 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureportplus.image;
...
import com.kingint.ureportplus.provider.image.ImageProvider;
...
public class StaticImageProcessor implements ImageProcessor<String> {
	...
	public InputStream getImage(String path) {
		...
		try{
			...
			String imageNotExistPath="classpath:com/kingint/ureportplus/image/image-not-exist.jpg";
			try {

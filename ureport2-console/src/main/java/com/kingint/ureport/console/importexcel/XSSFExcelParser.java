 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureport.console.importexcel;
...
import com.kingint.ureport.definition.PaperSize;
...
public class XSSFExcelParser extends ExcelParser {
	...
	private CellStyle buildCellStyle(XSSFCell cell,XSSFWorkbook book){
		...
		if(!borderStyle.equals(BorderStyle.NONE)){
			...
			border.setStyle(com.kingint.ureport.definition.BorderStyle.solid);
			border.setWidth(1);

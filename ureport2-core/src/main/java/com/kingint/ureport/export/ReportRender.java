 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureport.export;
...
import com.kingint.ureport.export.builder.down.DownCellbuilder;
import com.kingint.ureport.export.builder.right.RightCellbuilder;
import com.kingint.ureport.model.Report;
import com.kingint.ureport.parser.ReportParser;
...
public class ReportRender implements ApplicationContextAware{
	...
	private void addRowChildCell(CellDefinition cell,CellDefinition childCell,HashSet<String> visited){
		...
		if(visited.contains(name)){
			throw new com.kingint.ureport.exception.ReportException("Circular left-parent-cell reference detected at cell ["+name+"].");
		}
		visited.add(name);
	...
	private void addColumnChildCell(CellDefinition cell,CellDefinition childCell,HashSet<String> visited){
		...
		if(visited.contains(name)){
			throw new com.kingint.ureport.exception.ReportException("Circular top-parent-cell reference detected at cell ["+name+"].");
		}
		visited.add(name);

 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureport.export.excel.high.builder;
...
import com.kingint.ureport.export.excel.high.CellStyleContext;
			...
			for(Page page:pages){
				...
				for(int rowIndex=0;rowIndex<rows.size();rowIndex++){
		        	...
		        	for(int i=0;i<columnSize;i++){
		        		...
		        		com.kingint.ureport.model.Cell cellInfo=null;
		        		if(colCell!=null){

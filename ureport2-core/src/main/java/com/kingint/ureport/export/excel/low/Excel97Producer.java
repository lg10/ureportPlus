 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureport.export.excel.low;
...
import com.kingint.ureport.definition.PaperType;
...
import com.kingint.ureport.utils.ImageUtils;
...
public class Excel97Producer {
	...
	private void doProduce(Report report, OutputStream outputStream,boolean withPaging,boolean withSheet) {
		...
		try{
			...
			Map<Row,Map<Column,com.kingint.ureport.model.Cell>> cellMap=report.getRowColCellMap();
			...
			if(withPaging){
				...
				for(Page page:pages){
					...
					for(Row r:rows){
			        	...
			        	Map<Column,com.kingint.ureport.model.Cell> colCell=cellMap.get(r);
			        	for(int i=0;i<columnSize;i++){
			        		...
			        		com.kingint.ureport.model.Cell cellInfo=colCell.get(col);
			        		if(cellInfo==null){
			        			continue;
			        		}

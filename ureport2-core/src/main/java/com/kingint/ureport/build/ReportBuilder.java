 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureport.build;
...
import com.kingint.ureport.build.cell.CellBuilder;
import com.kingint.ureport.build.cell.NoneExpandBuilder;
import com.kingint.ureport.build.cell.down.DownExpandBuilder;
import com.kingint.ureport.build.cell.right.RightExpandBuilder;
import com.kingint.ureport.build.paging.BasePagination;
import com.kingint.ureport.build.paging.Page;
import com.kingint.ureport.build.paging.PagingBuilder;
import com.kingint.ureport.definition.Band;
import com.kingint.ureport.definition.Expand;
import com.kingint.ureport.definition.Orientation;
import com.kingint.ureport.definition.PagingMode;
import com.kingint.ureport.definition.Paper;
import com.kingint.ureport.definition.ReportDefinition;
import com.kingint.ureport.definition.datasource.BuildinDatasource;
import com.kingint.ureport.definition.datasource.BuildinDatasourceDefinition;
import com.kingint.ureport.definition.datasource.DatasourceDefinition;
import com.kingint.ureport.definition.datasource.DatasourceProvider;
import com.kingint.ureport.definition.datasource.JdbcDatasourceDefinition;
import com.kingint.ureport.definition.datasource.SpringBeanDatasourceDefinition;
...
public class ReportBuilder extends BasePagination implements ApplicationContextAware{
	...
	public Report buildReport(ReportDefinition reportDefinition,Map<String,Object> parameters) {
		...
		try {
			...
			for(com.kingint.ureport.model.Row r : report.getRows()){
				com.kingint.ureport.model.Column firstCol = report.getColumns().get(0);
				java.util.Map<com.kingint.ureport.model.Column, com.kingint.ureport.model.Cell> cm = report.getRowColCellMap().get(r);
				com.kingint.ureport.model.Cell c = cm!=null ? cm.get(firstCol) : null;

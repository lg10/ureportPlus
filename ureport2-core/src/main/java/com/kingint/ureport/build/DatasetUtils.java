...
import com.kingint.ureport.build.aggregate.Aggregate;
import com.kingint.ureport.build.aggregate.AvgAggregate;
import com.kingint.ureport.build.aggregate.CountAggregate;
import com.kingint.ureport.build.aggregate.CustomGroupAggregate;
import com.kingint.ureport.build.aggregate.GroupAggregate;
import com.kingint.ureport.build.aggregate.MaxAggregate;
import com.kingint.ureport.build.aggregate.MinAggregate;
import com.kingint.ureport.build.aggregate.RegroupAggregate;
import com.kingint.ureport.build.aggregate.ReselectAggregate;
import com.kingint.ureport.build.aggregate.SelectAggregate;
import com.kingint.ureport.build.aggregate.SumAggregate;
import com.kingint.ureport.definition.value.AggregateType;
import com.kingint.ureport.exception.CellComputeException;

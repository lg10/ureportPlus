 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureportplus.console.designer;
...
import com.kingint.ureportplus.expression.ErrorInfo;
import com.kingint.ureportplus.expression.ScriptErrorListener;
...
public class DesignerServletAction extends RenderPageServletAction {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(method!=null){
			...
			Template template=ve.getTemplate("ureportplus-html/designer.html","utf-8");

 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureportplus.console.importexcel;
...
import com.kingint.ureportplus.definition.PaperSize;
...
public class XSSFExcelParser extends ExcelParser {
	...
	private CellStyle buildCellStyle(XSSFCell cell,XSSFWorkbook book){
		...
		if(!borderStyle.equals(BorderStyle.NONE)){
			...
			border.setStyle(com.kingint.ureportplus.definition.BorderStyle.solid);
			border.setWidth(1);

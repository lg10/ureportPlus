 ...
 * Enabled by simply configuring ureportplus.console.username in config.properties.
...
public class ConsoleAuthService {
	...
	private static final String SESSION_KEY = "ureportplus_console_authed";
	...
	private void loadConfig() {
		...
		try {
			...
			if (in != null) {
				props.load(in);
				username = props.getProperty("ureportplus.console.username", "").trim();
				password = props.getProperty("ureportplus.console.password", "").trim();

 ...
 * the License.
 ******************************************************************************/
package com.kingint.ureportplus.console.res;
...
import com.kingint.ureportplus.console.ServletAction;
...
public class ResourceLoaderServletAction implements ServletAction,ApplicationContextAware{
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String path=req.getContextPath()+UReportPlusServlet.URL+URL;

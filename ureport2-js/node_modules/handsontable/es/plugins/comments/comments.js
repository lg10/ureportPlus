...
var Comments = function (_BasePlugin) {
  ...
  _createClass(Comments, [{
    ...
    value: function onMouseOver(event) {
      ...
      debounce(function () {
        if (hasClass(event.target, 'wtBorder') || priv.cellBelowCursor !== event.target || !_this4.editor) {
          return;
        }
        ...
        if (_this4.targetIsCellWithComment(event)) {
          ...
          _this4.show();
        } else if (isChildOf(event.target, document) && !_this4.targetIsCommentTextArea(event) && !_this4.editor.isFocused()) {
          _this4.hide();
        }
      }, this.displayDelay)();
    }
    ...
    value: function addToContextMenu(defaultOptions) {
      ...
      defaultOptions.items.push(getPlugin(this.hot, 'contextMenu').constructor.SEPARATOR, {
        key: 'commentsAddEdit',
        name: function name() {

...
export default function buildMenuConfigure(){
    return {
        ...
        items: {
            "insert_row_above": {
                name: `<i class="ureportplus ureportplus-insertrow" style="color: #3344d3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertRowUp}`
            },
            "insert_row_below": {
                name: `<i class="ureportplus ureportplus-insertrow" style="color: #3344d3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertRowDown}`
            },
            "insert_col_left": {
                name: `<i class="ureportplus ureportplus-insert-column" style="color: #008ed3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertColBefore}`
            },
            "insert_col_right": {
                name: `<i class="ureportplus ureportplus-insert-column" style="color: #008ed3;font-size: 13px"></i> ${window.i18n.table.contextMenu.insertColAfter}`
            },
            "del_row": {
                name: `<i class="ureportplus ureportplus-deleterow" style="color: #d30a16;font-size: 13px"></i>  ${window.i18n.table.contextMenu.delRow}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "del_col": {
                name: `<i class="ureportplus ureportplus-deletecolumn" style="color: #d30a16;font-size: 13px"></i>  ${window.i18n.table.contextMenu.delCol}`,
                disabled:checkColDeleteOperationDisabled
            },
            "row_height": {
                name: `<i class="ureportplus ureportplus-height" style="color: #d30a16;font-size: 13px;font-weight:bold"></i>  ${window.i18n.table.contextMenu.rowHeight}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "col_width": {
                name: `<i class="ureportplus ureportplus-width" style="color: #d30a16;font-size: 13px;font-weight:bold"></i>  ${window.i18n.table.contextMenu.colWidth}`,
                disabled:checkColDeleteOperationDisabled
            },
            "title_row": {
                name: `<i class="ureportplus ureportplus-title" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.title}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "repeat_row_header": {
                name: `<i class="ureportplus ureportplus-header-repeat" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.repeatHeader}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "repeat_row_footer": {
                name: `<i class="ureportplus ureportplus-footer-repeat" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.repeatFooter}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "summary_row": {
                name: `<i class="ureportplus ureportplus-summary" style="color: #9C27B0;font-size: 13px"></i>  ${window.i18n.table.contextMenu.summary}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "subtotal_row": {
                name: `<i class="ureportplus ureportplus-summary" style="color: #0e90d2;font-size: 13px"></i>  ${window.i18n.table.contextMenu.subtotal}`,
                disabled:checkRowDeleteOperationDisabled
            },
            "repeat_cancel": {
            ...
            "copy_style": {
                name: `<i class="ureportplus ureportplus-copy" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.copy}`,
                disabled:checkCopyOperationDisabled
            },
            "paste_style": {
                name: `<i class="ureportplus ureportplus-paste" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.paste}`,
                disabled:checkPasteOperationDisabled
            },
            "clean_content": {
                name: `<i class="ureportplus ureportplus-clean-content" style="color: #007471;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearContent}`,
                disabled:checkCleanOperationDisabled
            },
            "clean_style": {
                name: `<i class="ureportplus ureportplus-clean-style" style="color: #00746f;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearStyle}`,
                disabled:checkCleanOperationDisabled
            },
            "ai_assist": {
            ...
            "clean": {
                name: `<i class="ureportplus ureportplus-clean" style="color: #d30e00;font-size: 13px"></i>  ${window.i18n.table.contextMenu.clearAll}`,
                disabled:checkCleanOperationDisabled
            }
        }
    };
